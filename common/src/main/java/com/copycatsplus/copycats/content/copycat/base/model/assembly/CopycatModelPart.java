 ...
 * returned by a {@link com.copycatsplus.copycats.content.copycat.base.model.CopycatModelCore.ModelGetter}.
 * <p>
 ...
 * {@link com.copycatsplus.copycats.content.copycat.base.model.assembly.quad.QuadTransform} can be passed to the
...
public interface CopycatModelPart {
     ...
     *
     * @param key      The key of the model provided by the context. For simple copycats, the key of the copied material is {@link com.copycatsplus.copycats.content.copycat.base.model.CopycatModelCore#MATERIAL_KEY}. For multi-state copycats, the keys come from the storage properties of the copycat.
